...
md"# Snowflakes with turtle graphics
"
...
"""
Draw branches of ice crystals... not yet implemented

idea: - add symmetric branches (mirrored, scale = -1)
      - make recursive to make structure more interesting.

"""
function addBranches(turtle)
	# place holder for code that adds icycle branches at 30,60º angles at
	# a given branch point. 
	#
	# idea: can also make this recursive!
end
